...
use App\Http\Middleware\CheckHead;
...
Route::middleware([CheckAdmin::class])->group(function() {
    Route::get('/admin/employees/{id}', [Admin::class, 'employee_list_admin'])->name('admin.employees');
    Route::get('/admin/divisions', [Admin::class, 'division_list_admin'])->name('admin.divisions');
...
Route::middleware([CheckHead::class])->group(function() {
    Route::get('/head/employees', [Head::class, 'employees'])->name('head_employees');
    Route::get('/head/dashboard', [Head::class, 'dashboard']);
    Route::get('/head/employee/{id}',[Head::class, 'employee'])->name('employee.view');
    Route::get('head/tasks', [Head::class, 'tasks'])->name('head.tasks');
...
// Route::controller(Head::class)->middleware('employee')->group(function() {
...
// Route::get('/login', [LoginEmployee::class, 'create'])->name('employee.login');
